...
import com.cavcav.config.JwtProvider;
import com.cavcav.domain.*;
import com.cavcav.exception.*;
import com.cavcav.model.*;
import com.cavcav.repository.VerificationCodeRepository;
import com.cavcav.response.ApiResponse;
import com.cavcav.response.AuthResponse;
import com.cavcav.service.*;
import com.cavcav.service.impl.CustomeUserServiceImplementation;
import com.cavcav.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Cavcav Bazaar Login Otp";
        String text = "your login otp is - "+otp;
        emailService.sendVerificationOtpMail(req.getEmail(), verificationCode.getOtp(), subject, text);
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Cavcav Bazaar Email Verification Code";
        String text = "Welcome to Cavcav Bazaar, verify your account using this link ";
